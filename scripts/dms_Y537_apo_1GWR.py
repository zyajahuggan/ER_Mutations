#!/usr/bin/env python3
"""
dms_Y537_apo_1GWR.py

Deep mutation scan at Y537 of the apo ERα monomer + real TIF2 coactivator peptide
...
even without ligand bound (relevant for constitutively-active Y537 mutants).
...
def main():
    ...
    parser.add_argument("--out_dir", default=os.path.join(repo, "outputs", "dms_Y537_apo_1GWR"),
