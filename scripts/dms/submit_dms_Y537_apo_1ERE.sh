...
mkdir -p "${REPO}/logs" "${REPO}/outputs/dms/dms_1ERE/dms_Y537_apo_1ERE"
...
python3 "${REPO}/scripts/dms/dms_Y537_apo.py" \
    --wt_pdb  "${REPO}/inputs/1ERE/1ERE_clean_apo.pdb" \
    --xml     "${REPO}/scripts/dms/dms_Y537_apo.xml" \
    --out_dir "${REPO}/outputs/dms/dms_1ERE/dms_Y537_apo_1ERE" \
    --prefix  1ERE \
    --nstruct 5 \
