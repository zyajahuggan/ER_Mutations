...
Deep mutation scan at H524 of the holo ERα monomer + real TIF2 coactivator peptide
...
def main():
    ...
    parser.add_argument("--out_dir",    default=os.path.join(repo, "outputs", "dms_H524_holo_1GWR"),
