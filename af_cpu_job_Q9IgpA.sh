...
module load jq
singularity exec --pwd /app/alphafold --nv   --bind "inputs/af3_jsonwt_251_2000_batched":/root/af_input   --bind "/home/zhuggan1/scr4_jgray21/zhuggan1/repos/ER_Mutations/af_part1_kYzTFA":/root/af_output   --bind "/scratch4/datasets/alphafold3_models":/root/models   --bind "/scratch4/datasets/alphafold3":/root/public_databases   /data/apps/extern/singularity/alphafold/alphafold3_exec python run_alphafold.py \
  --norun_inference \
