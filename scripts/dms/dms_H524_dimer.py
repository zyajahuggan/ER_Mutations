...
Deep mutation scan at H524 of the holo ERα homodimer (1A52, both chains, both estradiol).
...
Output: outputs/dms_H524_dimer/<tag>_rep<n>.pdb
        outputs/dms_H524_dimer/dms_H524_dimer_scores.csv
...
def main():
    ...
    parser.add_argument("--out_dir",    default=os.path.join(repo, "outputs", "dms_H524_dimer"),
