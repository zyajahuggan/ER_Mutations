...
Output: outputs/dms_H524_dimer_apo/<tag>_rep<n>.pdb
        outputs/dms_H524_dimer_apo/dms_H524_dimer_apo_scores.csv

Workflow:
  1. Workers init PyRosetta and load the WT homodimer pose once.
  2. Each job: clone WT → mutate H524 on both chain A and chain B → FastRelax → dump PDB.
...
def main():
    ...
    parser.add_argument("--out_dir", default=os.path.join(repo, "outputs", "dms_H524_dimer_apo"),
