...
#SBATCH --job-name=ER_DMS_H524_dimer_1ERE
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
mkdir -p "${REPO}/logs" "${REPO}/outputs/dms/dms_1ERE/dms_H524_dimer_holo_1ERE"
...
# Step 3: DMS
echo "[$(date)] Starting 1ERE holo homodimer DMS at H524 ..."
python3 "${REPO}/scripts/dms/dms_H524_dimer.py" \
    ...
    --out_dir    "${REPO}/outputs/dms/dms_1ERE/dms_H524_dimer_holo_1ERE" \
    --prefix     1ERE \
    --nstruct    5 \
